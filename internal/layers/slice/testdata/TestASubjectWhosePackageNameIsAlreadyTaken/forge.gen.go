...
// passed in.
func NewPersons(elems ...slices2.Person) Persons { return slices.Clone(elems) }
...
// it.
func (s Persons) All() iter.Seq[slices2.Person] { return slices.Values(s) }

// Backward walks the container from the last element to the first. Like All,
// the walk is fixed when it is called.
func (s Persons) Backward() iter.Seq[slices2.Person] {
	return func(yield func(slices2.Person) bool) {
...
func (s *Persons) AppendSeq(seq iter.Seq[slices2.Person]) { *s = slices.AppendSeq(*s, seq) }
