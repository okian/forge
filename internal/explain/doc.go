// Package explain says what a declaration resolves to.
//
...
//
// The rendering is deliberately two: a table for a person and a document for a
// program. Neither is the other's serialisation — a table that a script parses
// becomes a format nobody can improve, and a document that a person reads is
