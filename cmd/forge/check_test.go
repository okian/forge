...
func TestHowAFileIsOutOfDate(t *testing.T) {
	...
	var sum emit.Digest
	generated.Fingerprint(&sum, held, "model", cfg)
	...
	var was emit.Digest
	generated.Fingerprint(&was, held, "model", older)
	...
	for name, want := range cases {
		t.Run(name, func(t *testing.T) {
			got, moved := staleness(want.recorded, held, "model", cfg)
...
func TestAFileWrittenByDifferentTooling(t *testing.T) {
	...
	if !strings.Contains(said, "nothing about the declaration has changed") {
